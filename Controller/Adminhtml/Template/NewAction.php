...
namespace SalesIgniter\Maintenance\Controller\Adminhtml\Template;
...
class NewAction extends Action
{
    ...
    {
        return true;
        // return $this->_authorization->isAllowed('Genmato_Sample::itemlist');
    }
    ...
    {
        $itemId = $this->getRequest()->getParam('template_id');
        ...
        $resultPage->getLayout()
            ->addBlock('SalesIgniter\Maintenance\Block\Adminhtml\Template\Edit', 'maintenancetemplate', 'content')
