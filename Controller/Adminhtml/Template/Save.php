...
class Save extends Action
{
    ...
    public function __construct(
        ...
        \SalesIgniter\Maintenance\Model\TemplateFactory $itemFactory,
    ...
    public function execute()
    {
        ...
        $redirectPath = 'salesigniter_maintenance/template';
        try {
            if ($id !== null) {
            ...
            $resultRedirect->setPath($redirectPath, ['template_id' => $id]);
        }
