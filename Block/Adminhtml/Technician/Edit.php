...
namespace SalesIgniter\Maintenance\Block\Adminhtml\Technician;
...
class Edit extends Container
{
    ...
    {
        $this->_objectId = 'maintainer_id';
        $this->_controller = 'adminhtml_technician';
        $this->_blockGroup = 'SalesIgniter_Maintenance';

        parent::_construct();

        $itemId = $this->getMaintainerId();
        if (!$itemId) {
