...
{
    /** Url path */
    const DEMO_URL_PATH_EDIT = 'salesigniter_maintenance/ticket/edit';
    const DEMO_URL_PATH_DELETE = 'salesigniter_maintenance/ticket/delete';
    /** @var UrlBuilder */
        ...
        if (isset($dataSource['data']['items'])) {
            foreach ($dataSource['data']['items'] as & $item) {
                ...
                if (isset($item['ticket_id'])) {
                    ...
                    $item[$name]['delete'] = [
                        'href' => $this->urlBuilder->getUrl(self::DEMO_URL_PATH_DELETE, ['ticket_id' => $item['ticket_id']]),
                        'label' => __('Delete'),
                        'confirm' => [
