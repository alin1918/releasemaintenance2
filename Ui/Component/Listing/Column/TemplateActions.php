...
{
    /** Url path */
    const DEMO_URL_PATH_EDIT = 'salesigniter_maintenance/template/edit';
    const DEMO_URL_PATH_DELETE = 'salesigniter_maintenance/template/delete';
    /** @var UrlBuilder */
        ...
        if (isset($dataSource['data']['items'])) {
            foreach ($dataSource['data']['items'] as & $item) {
                ...
                if (isset($item['template_id'])) {
                    ...
                    $item[$name]['delete'] = [
                        'href' => $this->urlBuilder->getUrl(self::DEMO_URL_PATH_DELETE, ['template_id' => $item['template_id']]),
                        'label' => __('Delete'),
                        'confirm' => [
